...
#include "Module6WayPoints.h"

using namespace Aftr;

std::string comicSans(ManagerEnvironmentConfiguration::getSMM() + "/fonts/COMIC.ttf");

GLViewModule6* GLViewModule6::New( const std::vector< std::string >& args )
{
   GLViewModule6* glv = new GLViewModule6( args );
...
GLViewModule6::GLViewModule6( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewModule6::New() for
   ...
   //GLViewModule6::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewModule6::onCreate()
{
   //GLViewModule6::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewModule6::~GLViewModule6()
{
   //Implicitly calls GLView::~GLView()
}


void GLViewModule6::updateWorld()
{
...
void GLViewModule6::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewModule6::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewModule6::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewModule6::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewModule6::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void GLViewModule6::onKeyUp( const SDL_KeyboardEvent& key )
{
   GLView::onKeyUp( key );
}


void Aftr::GLViewModule6::loadMap()
{
   ...
   string->getModelT<MGLFTGLString>()->setText("Not Sure What this is for");
   string->setText("Hello Game Engine Design!");
   ...
   createModule6WayPoints();
}


void GLViewModule6::createModule6WayPoints()
{
